...
description: "Some dumb description." # Quotation marks allow colons, semicolons, etc.
author: Al Sessions
...
{% lazypicture "guy.jpg", "A picture of some guy." %}
...
7
8
9{% lazypicture "some-guy.jpg", "A picture of some guy." %}
========= */
